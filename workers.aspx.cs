...
public partial class allmembers : System.Web.UI.Page
{
  ...
  private void ExportGridToExcel()
  {
    ...
    Response.Charset = "";
    string FileName = "AllWorkers" + DateTime.Now + ".xls";
  ...
  protected void Button3_Click(object sender, EventArgs e)
  {
    ...
    myCommand.CommandText = "select FirstName,LastName,Phone from Member_Data where WorkerStatus='Yes'";
